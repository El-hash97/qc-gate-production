    ...
    await sql.transaction([
      sql`
        INSERT INTO history
          (date, shift, shift_time, operator, pic, target, target_bc, target_cam, target_crank,
           ...
           hourly_data_cam, hourly_data_crank, hourly_data_bc1, hourly_data_bc2,
        ...
        VALUES (
          ...
          ${JSON.stringify((current as any).hourlyDataBc1 ?? {})}::jsonb,
          ${JSON.stringify((current as any).hourlyDataBc2 ?? {})}::jsonb,
          ...
          ${JSON.stringify(current.hourlyWindow ?? {})}::jsonb,
      ...
      sql`
        UPDATE production_state SET
          ...
          hourly_data_cam = '{}'::jsonb, hourly_data_crank = '{}'::jsonb, hourly_data_bc1 = '{}'::jsonb, hourly_data_bc2 = '{}'::jsonb,
